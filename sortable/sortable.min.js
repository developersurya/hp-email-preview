...
dragula([ $('template-list')])
  ...
  .on('drop', function (el) {
    ...
    var sortData = []; // main object
    jQuery('#template-list li').each(function(order){
      sortData[order] = { order:jQuery(this).data('id')}; 
    });
    var siteUrl = jQuery('#template-list').data('url'); 
    jQuery.ajax({
      method: "POST",
      url: siteUrl+"/update-sort.php",
